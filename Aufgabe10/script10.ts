 ...
 */
 ...
 var counter_openDOMElement: HTMLElement;
 var counter_doneDOMElement: HTMLElement;
 ...
 window.addEventListener("load", function(): void {
     ...
     counter_openDOMElement = document.querySelector("#counter_open");
     counter_doneDOMElement = document.querySelector("#counter_done");
 ...
 function updateCounter(): void {
     ...
     counter_openDOMElement.innerHTML = todosText.length + " open";
     counter_doneDOMElement.innerHTML = todosText.length + " done";
 }
